            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" style="width: 80%;">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <input style="border-radius: .25rem!important;" type="text" name="playlist" list="playlists" class="form-control" value="<?php echo $_SESSION["playlist"]; ?>" placeholder="Playlist" autocomplete="off" aria-label="Playlist" aria-describedby="inputGroup-sizing-default">
